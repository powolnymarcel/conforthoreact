                ...
                <div class="row">
                        ...
                        <div class="pbmit-entry-content">
                            <div class="pbmit-service_content">
                                <div class="pbmit-heading animation-style2">
                                    <h3 class="pbmit-title mb-3">{{$categories[0]->title}}</h3>
                                </div>
                            ...
                            <div class="ihbox_style_box">
                                <div class="row">
                                    @if(isset($categories[0]) && $categories[0]->products->isNotEmpty())
                    ...
                    <div class="col-lg-3 service-left-col sidebar">
                        <aside class="service-sidebar">
                            ...
                            <aside class="widget pbmit-service-ad" style="background-image: url(phone2.jpg);">
