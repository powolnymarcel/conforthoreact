...
export default function Edit({ slide }: { slide: Slide }) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/slides/${slide.id}`);
    };

    return (
        <AdminLayout title="Modifier le slide">
            ...
            <div className="max-w-2xl">
                ...
                <Card>
                    <CardHeader><CardTitle>Modifier le slide</CardTitle></CardHeader>
                    <CardContent>
