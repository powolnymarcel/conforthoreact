...
export default function Create({ categories }: { categories: ProductCategory[] }) {
    const { data, setData, post, processing, errors } = useForm({
        product_category_id: '',
        picture: '',
        title: '',
        description: '',
        mettre_en_avant: false,
        afficher: true,
    });
    ...
    return (
        <AdminLayout title="Créer un produit">
                    ...
                    <CardContent>
                        <form onSubmit={submit} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Select value={String(data.product_category_id)} onValueChange={(val) => setData('product_category_id', val)}>
